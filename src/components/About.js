...
const About = () => {
	return (
			...
			<div className="abtcontent">
				...
				<Styledp>I am currently looking for a job as a web developer in the Dallas area. Prior to studying web development, I worked in a few different industries that each used software in a different way. I was able to see firsthand the impact of software development in the real world. I graduate from DevMountain's Web Development Immersive course on March 1st and look forward to the continuing to learn and grow as a developer.</Styledp>
			</div>
			</Abt>
	);
}
